package com.joonaskinnunen.weatherwidget
...
class WeatherAppWidgetProvider : AppWidgetProvider() {
    ...
    override fun onUpdate(
        ...
        appWidgetIds.forEach { appWidgetId ->;
            ...
            refreshIntent.action = "com.joonaskinnunen.weatherwidget.REFRESH"
...
// time
                    ...
                    views.setImageViewResource(R.id.refreshImageView, R.drawable.ic_refresh_black_24dp)
...
// start loading data with Volley
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (intent.action == "com.joonaskinnunen.weatherwidget.REFRESH") {
            // get manager
